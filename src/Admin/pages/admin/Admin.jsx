...
const Table = ({ student}) => {
  const navigate = useNavigate();
    ...
    const deleteUser = async() =>{
        const response = await axios.delete(`https://placement-management-system-mroj.onrender.com/api/v1/admin/deleteUser/${student._id}`);
  ...
  return (
      <tr key={student._id}>
                        ...
                        <td className="whitespace-nowrap px-12 py-4">
                          <div className="text-sm text-gray-900 ">{student.
employId
}</div>
                          {/* <div className="text-sm text-gray-700">{resource.ResourceName}</div> */}
                        </td>
