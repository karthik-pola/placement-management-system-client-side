...
const CreateAdmin = () => {
  ...
  const navigate = useNavigate();
        ...
        const handleSubmit = async() => {
            ...
            formData.append('employId', rollNo);          
            console.log("FormData:", formData);



          const response = await axios.post("https://placement-management-system-mroj.onrender.com/api/v1/admin/register" , formData)
          .then((res) => {
    ...
    <div className="mx-auto w-full max-w-8xl bg-slate-100 py-2 h-full rounded-lg">
      <div className="mx-auto my-4 max-w-2xl md:my-6">
        ...
        <div className="overflow-hidden rounded-xl bg-white p-4 shadow">
          <p className="text-sm font-bold text-gray-900">Add new admin</p>
