    ...
    <div className="relative w-full bg-white">
      <div className="mx-auto max-w-7xl lg:px-8">
        <div className="flex flex-col justify-center px-4 py-10 lg:px-6">
         ...
         More than 90% students got opportunities

          </h1>
          <p className="mt-8 max-w-3xl text-lg text-gray-700">
          Driven by innovation and a commitment to excellence, we continually enhance our platform to ensure seamless interactions and meaningful connections. Whether you're a student taking the first steps towards your dream career or a company looking to build a dynamic workforce, our Campus Recruitment Portal is here to support and guide you every step of the way.
        ...
        <div className="rounded-lg bg-gray-200 p-4">
          <img
            ...
            src="https://vignanits.ac.in/wp-content/uploads/2021/07/Our-Recruiters_2020-21_01.jpg"
            alt=""
          />
        </div>
      </div>
